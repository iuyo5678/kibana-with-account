define(function (require) {
  ...
  require('ui/modules')
    ...
    .directive('dashboardPanel', function (savedVisualizations, savedSearches, Notifier, Private, $injector) {
      ...
      var loadPanel = Private(require('plugins/admin/dashboard/components/panel/lib/load_panel'));
      var filterManager = Private(require('ui/filter_manager'));
      var notify = new Notifier();

      var services = require('plugins/admin/settings/saved_object_registry').all().map(function (serviceObj) {
      ...
      return {
        restrict: 'E',
        template: require('plugins/admin/dashboard/components/panel/panel.html'),
