define(function (require) {
  ...
  require('plugins/admin/dashboard/directives/grid');
  require('plugins/admin/dashboard/components/panel/panel');
  require('plugins/admin/dashboard/services/saved_dashboards');
  require('plugins/admin/dashboard/styles/main.less');

  require('ui/saved_objects/saved_object_registry').register(require('plugins/admin/dashboard/services/saved_dashboard_register'));
  ...
  require('ui/routes')
    .when('/dashboard', {
      template: require('plugins/admin/dashboard/index.html'),
      resolve: {
    ...
    return {
      controller: function ($scope, $rootScope, $route, $routeParams, $location, Private, getAppState) {
        ...
        $scope.configTemplate = new ConfigTemplate({
          save: require('plugins/admin/dashboard/partials/save_dashboard.html'),
          load: require('plugins/admin/dashboard/partials/load_dashboard.html'),
          share: require('plugins/admin/dashboard/partials/share.html'),
          pickVis: require('plugins/admin/dashboard/partials/pick_visualization.html'),
          options: require('plugins/admin/dashboard/partials/options.html')
        });
