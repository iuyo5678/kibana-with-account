define(function (require) {
  ...
  var html = require('plugins/admin/discover/components/field_chooser/discover_field.html');
  ...
  app.directive('discoverField', function ($compile) {
    return {
      ...
      link: function ($scope, $elem) {
        ...
        var detailsHtml = require('plugins/admin/discover/components/field_chooser/lib/detail_views/string.html');
