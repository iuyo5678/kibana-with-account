define(function (require) {
  ...
  require('plugins/admin/discover/components/field_chooser/discover_field');

  app.directive('discFieldChooser', function ($location, globalState, config, $route, Private) {
    var _ = require('lodash');
    var $ = require('jquery');
    var rison = require('ui/utils/rison');
    var fieldCalculator = require('plugins/admin/discover/components/field_chooser/lib/field_calculator');
    ...
    return {
      ...
      template: require('plugins/admin/discover/components/field_chooser/field_chooser.html'),
      link: function ($scope) {
