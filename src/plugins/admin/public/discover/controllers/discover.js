define(function (require) {
  ...
  require('ui/routes')
    .when('/discover/:id?', {
      template: require('plugins/admin/discover/index.html'),
  ...
  app.controller('discover', function ($scope, config, courier, $route, $window, Notifier,
    ...
    var HitSortFn = Private(require('plugins/admin/discover/_hit_sort_fn'));
    ...
    $scope.configTemplate = new ConfigTemplate({
      load: require('plugins/admin/discover/partials/load_search.html'),
      save: require('plugins/admin/discover/partials/save_search.html'),
      share: require('plugins/admin/discover/partials/share_search.html')
    });
