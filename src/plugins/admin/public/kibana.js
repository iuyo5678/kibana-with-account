require('plugins/admin/discover/index');
require('plugins/admin/visualize/index');
require('plugins/admin/dashboard/index');
require('plugins/admin/settings/index');
require('plugins/admin/doc/index');
require('ui/account');
