define(function (require, module, exports) {
  ...
  var sections = require('plugins/admin/settings/sections/index');
  require('plugins/admin/settings/styles/main.less');
  ...
  require('ui/modules')
    ...
    .directive('kbnSettingsApp', function (Private, $route, timefilter) {
      return {
        restrict: 'E',
        template: require('plugins/admin/settings/app.html'),
        transclude: true,
        scope: {
          sectionName: '@section'
        },
