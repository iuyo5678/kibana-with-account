define(function (require) {
  ...
  var toEditableConfig = require('plugins/admin/settings/sections/advanced/lib/to_editable_config');


  require('plugins/admin/settings/sections/advanced/advanced_row');

  require('ui/routes')
  .when('/settings/advanced', {
    template: require('plugins/admin/settings/sections/advanced/index.html')
  });
