define(function (require) {
  ...
  require('plugins/admin/settings/sections/indices/_indexed_fields');
  require('plugins/admin/settings/sections/indices/_scripted_fields');
  require('plugins/admin/settings/sections/indices/_index_header');

  require('ui/routes')
  .when('/settings/indices/:indexPatternId', {
    template: require('plugins/admin/settings/sections/indices/_edit.html'),
    resolve: {
  ...
  .controller('settingsIndicesEdit', function ($scope, $location, $route, config, courier, Notifier, Private, AppState, docTitle) {
    ...
    var refreshKibanaIndex = Private(require('plugins/admin/settings/sections/indices/_refresh_kibana_index'));
    ...
    var fieldTypes = Private(require('plugins/admin/settings/sections/indices/_field_types'));
