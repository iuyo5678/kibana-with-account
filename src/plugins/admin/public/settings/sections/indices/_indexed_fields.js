define(function (require) {
  ...
  .directive('indexedFields', function ($filter) {
    ...
    var noTemplate = '';
    var nameHtml = require('plugins/admin/settings/sections/indices/_field_name.html');
    var typeHtml = require('plugins/admin/settings/sections/indices/_field_type.html');
    var controlsHtml = require('plugins/admin/settings/sections/indices/_field_controls.html');
    var filter = $filter('filter');

    return {
      restrict: 'E',
      template: require('plugins/admin/settings/sections/indices/_indexed_fields.html'),
      scope: true,
      link: function ($scope) {
