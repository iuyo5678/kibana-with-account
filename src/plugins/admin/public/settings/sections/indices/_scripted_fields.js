define(function (require) {
  ...
  .directive('scriptedFields', function (kbnUrl, Notifier, $filter) {
    ...
    var popularityHtml = require('plugins/admin/settings/sections/indices/_field_popularity.html');
    var controlsHtml = require('plugins/admin/settings/sections/indices/_field_controls.html');
    ...
    return {
      restrict: 'E',
      template: require('plugins/admin/settings/sections/indices/_scripted_fields.html'),
      scope: true,
      link: function ($scope) {
        var dateScripts = require('plugins/admin/settings/sections/indices/_date_scripts');
