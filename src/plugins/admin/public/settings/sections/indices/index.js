define(function (require) {
  ...
  require('plugins/admin/settings/sections/indices/_create');
  require('plugins/admin/settings/sections/indices/_edit');
  require('plugins/admin/settings/sections/indices/_field_editor');
  ...
  require('ui/modules').get('apps/settings')
    .directive('kbnSettingsIndices', function ($route, config, kbnUrl) {
      return {
        restrict: 'E',
        transclude: true,
        template: require('plugins/admin/settings/sections/indices/index.html'),
        link: function ($scope) {
