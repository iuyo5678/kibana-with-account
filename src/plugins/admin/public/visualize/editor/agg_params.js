define(function (require) {
  ...
  require('ui/modules')
    ...
    .directive('visEditorAggParams', function ($compile, $parse, Private, Notifier, $filter) {
      ...
      var aggSelectHtml = require('plugins/admin/visualize/editor/agg_select.html');
      var advancedToggleHtml = require('plugins/admin/visualize/editor/advanced_toggle.html');
      ...
      return {
        restrict: 'E',
        template: require('plugins/admin/visualize/editor/agg_params.html'),
        scope: true,
