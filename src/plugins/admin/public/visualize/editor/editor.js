define(function (require) {
  ...
  require('ui/routes')
    .when('/visualize/create', {
      template: require('plugins/admin/visualize/editor/editor.html'),
      resolve: {
  ...
  require('ui/modules')
    ...
    .controller('VisEditor', function ($scope, $route, timefilter, AppState, $location, kbnUrl, $timeout, courier, Private, Promise) {
      ...
      var configTemplate = new ConfigTemplate({
        save: require('plugins/admin/visualize/editor/panels/save.html'),
        load: require('plugins/admin/visualize/editor/panels/load.html'),
        share: require('plugins/admin/visualize/editor/panels/share.html'),
      });
